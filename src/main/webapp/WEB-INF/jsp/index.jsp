...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/src/css/libs-main.css"/>
    <link rel="stylesheet" type="text/css" href="${ctx}/src/css/filemanager.min.css"/>
    ...
    <style type="text/css">
        .fm-container .fm-loading-wrap {
            ...
            left: 0;
            display: block;
            background: white url(${ctx}/images/spinner.gif) no-repeat center center;
            z-index: 999;
        }
    </style>
...
<div class="fm-container">
    ...
    <div class="fm-wrapper">
        ...
        <script type="text/javascript" src="${ctx}/src/js/libs-main.js"></script>
        <script type="text/javascript" src="${ctx}/src/js/filemanager.min.js"></script>
        <script type="text/javascript" src="${ctx}/config/filemanager.init.js"></script>
