package com.kiko.file.manager.impl;

import com.kiko.file.manager.AbstractFileManager;
import com.kiko.file.manager.MultipartFileSender;
import com.kiko.file.manager.error.ClientErrorMessage;
import com.kiko.file.manager.error.FMInitializationException;
import com.kiko.file.manager.error.FileManagerException;
import com.kiko.file.manager.model.FileAttributes;
import com.kiko.file.manager.model.FileData;
import com.kiko.file.manager.model.FileType;
import com.kiko.file.manager.util.*;
...
import static com.kiko.file.manager.util.FileUtils.getExtension;
...
public class LocalFileManager extends AbstractFileManager {
    ...
    private ArrayList<FileData> uploadFiles(HttpServletRequest request, String targetDirectory) throws FileManagerException {
        ...
        try {
            for (Part uploadedFile : request.getParts()) {
                ...
                String filename = normalizeName(FileUtils.getBaseName(submittedFileName)) + '.' + getExtension(submittedFileName);
    ...
    public List<FileData> actionExtract(String sourcePath, String targetPath) throws FileManagerException {
        ...
        if (!getExtension(sourceFile.getName()).toLowerCase().equals("zip")) {
            throw new FileManagerException(ClientErrorMessage.FORBIDDEN_ACTION_DIR);
        }
    ...
    protected File getThumbnail(String path, boolean create) throws FileManagerException, IOException {
        ...
        String ext = getExtension(originalFile.getName());
